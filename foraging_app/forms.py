...
from foraging_app.models import User_Profile
...
class UserProfileForm(forms.ModelForm):
    ...
    class Meta:
        model = User_Profile
        fields = ['first_name', 'last_name', 'home_address', 'phone', 'gender']

    def clean_gender(self):
        gender = self.cleaned_data.get('gender')
        print(f"Gender value: {gender}")  # Debugging line
        valid_choices = [str(choice[0]) for choice in User_Profile.GENDER_CHOICES]
