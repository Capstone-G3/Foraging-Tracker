...
class LoginTests(TestCase):
    ...
    def test_login_view_post_special_characters_username(self):
        ...
        User.object.create(username=special_username, password=make_password('testpassword'))
    ...
    def test_login_view_post_special_characters_password(self):
        ...
        User.object.create(username='testuser2', password=make_password(special_password))
    ...
    def test_login_view_post_unicode_username(self):
        ...
        User.object.create(username=unicode_username, password=make_password('testpassword'))
    ...
    def test_login_view_post_unicode_password(self):
        ...
        User.object.create(username='testuser3', password=make_password(unicode_password))
