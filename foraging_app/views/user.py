...
class User_View(View):
    ...
    def get(self, request, userId):
        ...
        # query number of incoming friend request to user
        try:
            friends_notification = Friend_Request.objects.filter(uid_receiver=this_user, status=1)
            friends_notification_count = friends_notification.count()

        except Friend_Request.DoesNotExist:
            friends_notification_count = None
        # query user to add
        try:
        ...
        return render(request, "user.html", {
            ...
            "friends_notification_count": friends_notification_count,
